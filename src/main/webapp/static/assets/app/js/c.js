window.SINGLE_TAB = "  ";
window.ImgCollapsed = "static/assets/app/image/Collapsed.gif";
window.ImgExpanded = "static/assets/app/image/Expanded.gif";
...
function EnsureIsPopulated() {
    ...
    if (!$id("Canvas").innerHTML) Process(window.json);
